          ...
          {isLoading || isFetching ? (
            ...
            <div className="bg-white rounded-2xl border border-pink-100 p-12 text-center shadow-sm">
              ...
              <p className="text-gray-600 mb-6">
                Create your first beauty category
              </p>
              <button
                onClick={() => openModal()}
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-pink-500 via-rose-500 to-purple-600 text-white font-semibold shadow hover:shadow-lg transition"
              >
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="flex justify-end gap-3 pt-3">
                ...
                <button
                  type="submit"
                  disabled={creating || updating}
                  className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-pink-500 via-rose-500 to-purple-600 text-white font-semibold shadow hover:shadow-lg transition disabled:opacity-50"
                >
                  {editing
                    ? updating
                      ? "Updating..."
